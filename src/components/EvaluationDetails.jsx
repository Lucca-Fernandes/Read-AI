...
const parseEvaluationText = (text) => {
  ...
  try {
    ...
    lines.forEach(line => {
      // Regex para encontrar o título de uma seção e o peso total
      ...
      // Regex para encontrar um critério, sua pontuação máxima e a pontuação obtida
      ...
      if (criteriaMatch && currentSection) {
       ...
       // Regex específico para o Redutor de Linguagem
    ...
    return { sections: [], summary: 'Falha ao processar a avaliação. Exibindo texto original.', finalScore: 0, rawText: text };
  }
};
